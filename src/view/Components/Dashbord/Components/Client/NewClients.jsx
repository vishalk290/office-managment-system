...
const NewClients = () => {
  ...
  const handleSubmit = (e) => {
    ...
    localStorage.setItem("NewClients", JSON.stringify(updatedClients));
        ...
        <ModalBody>
          <form onSubmit={handleSubmit}>
            <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "15px" }}>
              ...
              <div>
                <label style={{ display: "block", marginBottom: "5px", fontWeight: 500 }}>Client Id</label>
                <input
                  type="text"
                  name="no"
              ...
              <div>
                <label style={{ display: "block", marginBottom: "5px", fontWeight: 500 }}>Company Type</label>
                <input
                  type="text"
                  name="type"
