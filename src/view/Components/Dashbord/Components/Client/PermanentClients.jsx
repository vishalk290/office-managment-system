...
const PermanentClients = () => {
  ...
  useEffect(() => {
    const savedClients =
      JSON.parse(localStorage.getItem("PermanentClients")) || [];
  ...
  const handleSubmit = (e) => {
    ...
    localStorage.setItem("PermanentClients", JSON.stringify(updatedClients));
          ...
          {table.map((tab, idx) => (
            <button
              ...
              style={{
                padding: "8px 28px",
                fontWeight: 600,
                background: select === idx ? "#2563eb" : "#f8fafc",
                color: select === idx ? "#fff" : "#222",
                border: "1px solid #2563eb",
                borderBottom: select === idx ? "none" : "1px solid #2563eb",
                outline: "none",
                borderTopLeftRadius: idx === 0 ? 8 : 0,
                borderTopRightRadius: idx === table.length - 1 ? 12 : 0,
                cursor: "pointer",
                position: "relative",
                top: select === idx ? 1 : 0,
                zIndex: select === idx ? 1 : 0,
              }}
